...
public class frmUsuario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtTipo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Admin", "Académico", "Administrativo", "Profesor", "Alumno", "Guardia", "Otro" }));
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtNumAuto, javax.swing.GroupLayout.DEFAULT_SIZE, 111, Short.MAX_VALUE)
        ...
        jTabbedPane1.addTab("Registro Usuarios", jPanel3);
        ...
        jTabbedPane1.addTab("Consulta Usuarios", jPanel2);
    ...
    private void btGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btGuardarActionPerformed
        if (txtNumAuto.getText().isEmpty() || txtPlaca.getText().isEmpty() || txtMarcas.getText().isEmpty()
            ...
            try {
                ...
                Auto auto = new Auto(numAuto, placas, marca, color, tipo);
                listaAuto.add(auto);
                updateTable();
            } catch (Exception e) {
                JOptionPane.showMessageDialog(null, "FAVOR DE REVISAR CAMPOS", "ERROR", JOptionPane.ERROR_MESSAGE);
